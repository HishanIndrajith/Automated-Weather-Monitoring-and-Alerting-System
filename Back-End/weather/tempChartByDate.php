...
$mysql_qry = "SELECT date,temp FROM data_set1 WHERE date >= '".$date_selected." 00:00:00' AND date <= '".$date_selected." 23:59:59'  AND location = ". $location." ORDER BY date ASC ";
$result = mysqli_query($conn,$mysql_qry);
$myJSON="";
if(mysqli_num_rows($result) > 0){
    $ret = array();
    $no=1;
    $ret[0]=["time","temperature (°C)"];//headers
